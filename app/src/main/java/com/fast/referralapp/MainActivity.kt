...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Withdraw Click (Like Yono Rummy withdraw window)
        btnWithdraw.setOnClickListener {
            Toast.makeText(this, "Withdrawable Balance: ৳ 0.96 (Min withdraw ৳100)", Toast.LENGTH_LONG).show()
        }

        // Share Referral Link Click (Opens phone share sheet)
        btnShare.setOnClickListener {
            val shareText = "Join Fast Referral App and start earning daily! Use my link: https://fastreferralapp.com/?code=VIPQSYFW1U7"
